...
**批量填充** — 每项一键完成，也可以用**执行所有填充**同时执行全部：

| | |
|---|---|
| 餐厅 | 已有食材 · 全部食材（自动识别 DLC） · 分店库存 · 员工等级 |
...
<p align="center">
  <a href="https://fsd.fkey.id/"><img src="docs/images/support-banner-zh-Hans.png" alt="DiveSaveEd——永远免费，但不是零成本" width="880"></a>
</p>

<p align="center">
  <a href="https://fsd.fkey.id/"><img src="docs/images/btn-support-zh-Hans.png" alt="赞助 DiveSaveEd" height="48"></a>
</p>

<p align="center">
  <sub><b>只收加密货币。</b>Base 上的 USDC 最便宜——没有信用卡、Apple Pay 或 PayPal，也没有金额输入框。<br>
  如果你本来就没在用，真的不必特地去弄。<br>
  那个页面显示的是 <b>fsd</b>——那只是付款页上的代号，不是什么你应该认得的公司或个人。</sub>
</p>

DiveSaveEd 是免费的 MIT 许可项目。没有广告、没有付费版、没有任何功能被锁——而且不会改变。
但「用起来免费」和「做起来免费」是两回事：

| | |
|---|---|
| **每年 99 美元** | Apple 开发者会员费。macOS 之所以能正常打开这个 App，而不是弹出「无法识别的开发者」警告，就只是因为这笔钱。 |
| **每次游戏更新** | 重新生成物品与鱼类数据库，批量填充才不会填错。 |
| **每个语言** | 拿游戏自己发布的本地化数据去核对每一个游戏内名词，而不是把我们的英文翻过去。 |

如果你想知道这笔钱具体能补上什么洞，最直接的例子是：**物品数据库停在「In the Jungle」（丛林）DLC
之前，因为我没有买那个 DLC**。丛林独有的物品既查不到名字，也不在批量填充的范围里。这是钱真的能
解决的问题。

**比钱更有价值的事**。这是真心话——下面任何一件，对这个项目的帮助都大于几美元：

- [反馈问题](../../issues/new/choose)——App 的「帮助」菜单会帮你把细节填好
- [修正翻译](CONTRIBUTING.md)——它出四个语言，但我只有两个说得好
- 告诉身边用 Mac 玩这款游戏的人
- 给这个 repo 点个星，让其他人找得到

> **唯一的官方赞助链接就是上面那一个，以及[项目网站](https://hypery11.github.io/DaveTheDiverSaveEditor/zh/support/)上的那一个。**
> 其他任何地方声称「代收 DiveSaveEd 赞助」都不是我们——fork 或转载的 `.dmg` 里的加密货币地址
> 可以被替换，而且没人看得出来。
