...
DiveSaveEd 是免費的 MIT 授權專案 —— 沒有廣告、沒有付費版、沒有任何功能被鎖起來。如果它幫你省下了
刷取的時間,也想為背後的研究出點力(逆向存檔格式、維護物品資料、拿遊戲自己的在地化檔案核對術語),
這裡有個連結:

**[fsd.fkey.id](https://fsd.fkey.id/)**

它**只收加密貨幣** —— Base 上的 USDC 最便宜 —— 所以如果你本來沒在用,真的不必特地去弄。回報一個
bug,或修正四個語系翻譯裡的一處錯誤,對這個專案的價值都比幾塊美金高。

> 唯一的官方贊助連結就是這一個,以及專案網站上的那一個。其他任何地方聲稱「代收 DiveSaveEd 贊助」
> 都不是我們 —— fork 或轉載的 `.dmg` 裡的加密貨幣地址可以被換掉,而且沒人看得出來。
